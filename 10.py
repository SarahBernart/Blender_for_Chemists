...
# ========================
TEST_NAMES   = ["M1","1Vo","2O","2Vo","CO_1Vo","CO_O","CO_2O","CO","CO2_1Vo",
...
BASE_XYZ_DIR = "/Users/sarahbernart/calc/Kinetics/Cluster/Pd10_CeO2/Blender"
OUT_DIR      = os.path.expanduser('~/calc/Kinetics/Cluster/Pd10_CeO2/Blender/pics')
...
cam_obj.location       = Vector((0.5, -0.5, CAMERA_Z))
cam_obj.rotation_euler = Euler((0.0, 0.0, 0.0), 'XYZ')

cam_data.type        = 'ORTHO'
cam_data.ortho_scale = 12     # nur Bildbreite; bei Bedarf NUR diesen Wert feinjustieren
