...
# ========================
TEST_NAMES   = ["1Vo_sub","1Vo","2O","2Vo","CO_1Vo","CO_O","CO","CO2_1Vo","CO2_2Vo","CO2_O","CO2",
    "M1","O","O2_1Vo","O2_2Vo","O2","OCOO_1Vo","OCOO","TS_CO_1Vo","TS_CO_O","TS_CO",
    "TS_O2_1Vo","TS_O2_2Vo","TS_O2","TS_OCOO_1Vo","TS_OCOO"]  # <<-- HIER deine zwei Strukturen (ohne .xyz/.png)
BASE_XYZ_DIR = "/Users/sarahbernart/calc/Kinetics/SACs_edge/Pt1_CeO2/Blender"
OUT_DIR      = os.path.expanduser('~/calc/Kinetics/SACs_edge/Pt1_CeO2/Blender/pics')
...
# Kamera (fix, ORTHO)
# ========================
CAMERA_POS     = (3.5, -3.5, 12.0)
CAMERA_ROT_DEG = (40.0, 0.0, 40.0)
CAMERA_NAME    = "Camera"
...
if cam_obj is None:
    ...
    if not cam_obj.users_collection:
        bpy.context.scene.collection.objects.link(cam_obj)
else:
    cam_obj.data = cam_data

rx, ry, rz = [math.radians(v) for v in CAMERA_ROT_DEG]
cam_obj.location       = Vector(CAMERA_POS)
cam_obj.rotation_euler = Euler((rx, ry, rz), 'XYZ')

cam_data.type        = 'ORTHO'
cam_data.ortho_scale = 9     # nur Bildbreite; bei Bedarf NUR diesen Wert feinjustieren
